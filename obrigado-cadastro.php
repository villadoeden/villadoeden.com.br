<?php
$titulo = 'Cadastre-se - Villa do Éden';
$descricao = 'Agradecemos por se cadastrar em nosso site para receber nossas promoções!';
...
<!-- End Facebook Pixel Code -->
    ...
    <main>
        <div class="container">
            <section>
                <div class="">
                    <h1 class="titlepage">Cadastre-se</h1>

                    <div class="col-sm-12 text-center" >
                        <br>
                        <p>Agradecemos por se cadastrar em nosso site para receber nossas promoções!</p>
                        <p>Esperamos ter o prazer em recebe-lo em nosso hotel</p>
